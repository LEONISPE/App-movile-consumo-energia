...
class _AguaScreenState extends State<AguaScreen> {
  ...
  Future<void> _loadAguaData() async {
    try {
      final responseDiario = await _aguaService.getDataAguaConsumoDiario()
       .timeout(const Duration(seconds: 15));
      

      final responseAcomulado = await _aguaService.getDataAguaConsumoAcomulado()
       .timeout(const Duration(seconds: 15));
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Center(
                  child: FaIcon(FontAwesomeIcons.water, color: Colors.lightBlueAccent, size: 90),
                ),
